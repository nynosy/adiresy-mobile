...
public class StyleLoader {
    ...
    private static String buildInlineStyle(String absolutePath, boolean darkMode,
        ...
        return "{"
            + "\"version\":8,"
            + "\"name\":\"Adiresy Dev\","
            // Glyphs bundled in-app so labels render offline; space-free fontstack
            // names avoid URL-encoding ambiguity in the asset:// scheme.
            ...
            +    "[\"hospital\",\"doctor\",\"doctors\",\"clinic\",\"dentist\"],\"poi_healthcare\","
            +    "[\"school\",\"college\",\"university\",\"kindergarten\"],\"poi_education\","
            +    "[\"restaurant\",\"cafe\",\"fast_food\",\"bar\",\"pub\",\"food_court\",\"biergarten\"],\"poi_food\","
            +    "[\"bank\",\"atm\",\"money_transfer\",\"mobile_money_agent\"],\"poi_finance\","
            +    "[\"hotel\",\"hostel\",\"guest_house\",\"motel\",\"bed_and_breakfast\"],\"poi_lodging\","
            +    "[\"supermarket\",\"convenience\",\"clothes\",\"department_store\",\"mall\"],\"poi_shopping\","
            +    "[\"fuel\"],\"poi_fuel\","
            // Remaining categories reuse Maki pictograms (CC0) via PoiIconFactory;
            // keep this list in sync with poi-overlay.yml's include_when leaf values.
            +    "[\"veterinary\"],\"poi_veterinary\","
            +    "[\"library\"],\"poi_library\","
            +    "[\"police\"],\"poi_police\","
            +    "[\"fire_station\"],\"poi_fire\","
            +    "[\"townhall\",\"courthouse\",\"government\",\"diplomatic\",\"community_centre\"],\"poi_government\","
            +    "[\"post_office\"],\"poi_post\","
            +    "[\"embassy\"],\"poi_embassy\","
            +    "[\"place_of_worship\"],\"poi_worship\","
            +    "[\"cinema\"],\"poi_cinema\","
            +    "[\"theatre\",\"arts_centre\"],\"poi_theatre\","
            +    "[\"parking\"],\"poi_parking\","
            +    "[\"bus_station\",\"bus_stop\",\"platform\",\"stop_position\"],\"poi_bus\","
            +    "[\"ferry_terminal\"],\"poi_ferry\","
            +    "[\"station\",\"halt\"],\"poi_rail\","
            +    "[\"nursing_home\"],\"poi_care\","
            +    "[\"prison\"],\"poi_prison\","
            +    "[\"taxi\"],\"poi_taxi\","
            +    "[\"car_sharing\",\"car\"],\"poi_car\","
            +    "[\"bicycle_rental\"],\"poi_bicycle_rental\","
            +    "[\"bicycle_parking\",\"bicycle\"],\"poi_bicycle\","
            +    "[\"toilets\"],\"poi_toilets\","
            +    "[\"drinking_water\"],\"poi_water\","
            +    "[\"shelter\"],\"poi_shelter\","
            +    "[\"charging_station\"],\"poi_charging\","
            +    "[\"pharmacy\",\"chemist\"],\"poi_pharmacy_chemist\","
            +    "[\"bakery\"],\"poi_bakery\","
            +    "[\"alcohol\"],\"poi_alcohol\","
            +    "[\"marketplace\",\"butcher\",\"greengrocer\",\"beverages\"],\"poi_grocery_misc\","
            +    "[\"shoes\"],\"poi_shoes\","
            +    "[\"jewelry\"],\"poi_jewelry\","
            +    "[\"optician\"],\"poi_optician\","
            +    "[\"mobile_phone\"],\"poi_mobile\","
            +    "[\"hardware\",\"doityourself\"],\"poi_hardware\","
            +    "[\"garden_centre\"],\"poi_garden_centre\","
            +    "[\"travel_agency\"],\"poi_travel\","
            +    "[\"insurance\",\"lawyer\",\"estate_agent\",\"telecommunication\",\"association\",\"ngo\"],\"poi_office\","
            +    "[\"museum\",\"gallery\"],\"poi_museum\","
            +    "[\"information\"],\"poi_information\","
            +    "[\"zoo\",\"theme_park\",\"attraction\"],\"poi_attraction\","
            +    "[\"park\",\"garden\"],\"poi_park\","
            +    "[\"pitch\",\"sports_centre\",\"stadium\",\"golf_course\",\"playground\"],\"poi_sports\","
            +    "[\"swimming_pool\"],\"poi_swimming\","
            +    "[\"computer\",\"electronics\",\"furniture\",\"stationery\",\"kiosk\",\"books\",\"hairdresser\",\"beauty\",\"laundry\"],\"poi_shop_generic\","
            +    "\"poi_default\"],"
            +   "\"icon-size\":1.0,"
